...
import '../signup/signup_1_how_to_nominate.dart';

class LeaderSignup extends StatefulWidget {
  @override
  _LeaderSignupState createState() => _LeaderSignupState();
}
...
class _LeaderSignupState extends State<LeaderSignup> {
  ...
  void _navigateToNextScreen() {
    Navigator.pushAndRemoveUntil(
      context,
      MaterialPageRoute(builder: (context) => SignupHowToNominate()),
          (route) => false,
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Leader Signup")),
      body: Padding(
