...
class _MemberDashboardState extends State<MemberDashboard> with WidgetsBindingObserver {
    ...
    try {
      ...
      if (eventDoc.exists && eventDoc.data() != null) {
        ...
        if (data.containsKey("details") && data["details"] != null) {
          ...
          // Also fetch member specific status
          ...
          if (memberDoc.exists && memberDoc.data() != null) {
            memberOnline = (memberDoc.data() as Map<String, dynamic>)["isOnline"] ?? false;
          }
  ...
  Future<void> fetchStats() async {
    ...
    try {
      ...
      QuerySnapshot guestSnapshot = await _firestore
          ...
          .collection("guest")
          .get();
      int guests = guestSnapshot.docs.where((doc) => doc.id != "init").length;
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          FloatingMenu(
            isOpen: _menuOpen,
            eventCode: eventCode ?? "", // Use safe null check
            onClose: () {
              setState(() {
                _menuOpen = false;
              });
            ...
            IconButton(
              ...
              onPressed: () {
                Navigator.pushAndRemoveUntil(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          MemberNotificationScreen(eventCode: eventCode!)),
                  (route) => false,
                );
              },
            ),
