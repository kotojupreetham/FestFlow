...
class _NotificationSettingsState extends State<NotificationSettings> {
  ...
  Future<void> _loadPreferences() async {
    ...
    try {
      DocumentSnapshot doc = await _firestore.collection("leader").doc(user.email).get();
  ...
  Future<void> _savePreferences() async {
    ...
    try {
      await _firestore.collection("leader").doc(user.email).update({
        "notificationPrefs": {
          ...
          : Column(
              children: [
                ...
                Card(
                  margin: EdgeInsets.symmetric(horizontal: 12, vertical: 4),
                  child: SwitchListTile(
                    secondary: Icon(Icons.event, color: Colors.green),
                ...
                Card(
                  ...
                  child: SwitchListTile(
                    ...
                    subtitle: Text("Announcements and system alerts"),
                    value: generalAlerts,
                    onChanged: (value) {
